...
public class ServerClient implements Runnable, Closeable {
    ...
    private static final String CALCULATION_FAILED_SERVER_MSG = "Calculation failed for #%d: ";
    ...
    public void run() {
        ...
        while (scanner.hasNextLine()) {
            ...
            try {
                ...
                System.err.println(String.format(CALCULATION_FAILED_SERVER_MSG, clientId) + e.getMessage());
            }
        }
    }
